...
import { Command as CStatCommand, CStatDiagnosticsManager } from "../cstatDiagnostics";
...
import { IarWebView } from "./webview";
...
class Application {
    ...
    readonly iarHomeView: IarWebView;
    ...
    constructor(context: Vscode.ExtensionContext, toolManager: ToolManager) {
        ...
        CStatCommand.registerCommands(context, cstatDiagnostics);


        this.iarHomeView = new IarWebView(context);
        context.subscriptions.push(Vscode.commands.registerCommand('iar.openIarHome', () => {
            this.iarHomeView.open();
        }));
