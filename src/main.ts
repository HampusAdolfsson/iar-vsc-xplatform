...
import { TreeSelectionView } from './extension/ui/treeselectionview';
...
export function activate(context: vscode.ExtensionContext) {
    ...
    vscode.window.registerTreeDataProvider('iar-settings', new TreeSelectionView(context,
                                                                                    UI.getInstance().workbench.model,
                                                                                    UI.getInstance().compiler.model,
                                                                                    UI.getInstance().project.model,
                                                                                    UI.getInstance().config.model));
    UI.getInstance().show();
